...
module derivative_dp
    ...
    private
    public :: zonalDerivative_dp, meridionalDerivative_dp, verticalDerivative_dp
    ...
    end subroutine zonalDerivative_dp
    ...
    end subroutine meridionalDerivative_dp
    ...
    end subroutine verticalDerivative_dp

end module derivative_dp
