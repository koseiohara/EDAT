...
module derivative_sp
    ...
    private
    public :: zonalDerivative_sp, meridionalDerivative_sp, verticalDerivative_sp
    ...
    pure subroutine zonalDerivative_sp(lon, input, output, periodic, status)
    ...
    end subroutine zonalDerivative_sp


    pure subroutine meridionalDerivative_sp(lat, input, output, status)
    ...
    end subroutine meridionalDerivative_sp


    pure subroutine verticalDerivative_sp(lev, input, psfc, output, undef, status)
    ...
    end subroutine verticalDerivative_sp

end module derivative_sp
