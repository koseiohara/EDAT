...
module integral_dp
    ...
    private
    public :: meridionalIntegral_dp, verticalIntegral_dp

    contains


    pure subroutine meridionalIntegral_dp(lat, field, south, north, output, status, valid_south, valid_north)
    ...
    end subroutine verticalIntegral_dp

end module integral_dp
